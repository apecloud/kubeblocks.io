...
<div>
  <img src={require("./images/mysql-rt.png").default} alt="mysql rt" style={{padding: "10px 10%"}} />
</div>
...
<div>
  <img src={require("./images/max-throughput.png").default} alt="max throughput" style={{padding: "10px 10%"}} />
</div>
...
<div>
  <img src={require("./images/MySQL-and-sysbench-are-deployed-in-the-same-K8s-cluster.png").default} alt="Deploy MySQL and sysbench in the same K8s cluster" style={{padding: "10px 10%"}} />
</div>

#### Read-intensive workload

<div style={{display: "flex"}}>
  <img src={require("./images/Read-intensive-workload-1.png").default} alt="Image 1" style={{width: "33%", padding: "5px"}} />
  <img src={require("./images/Read-intensive-workload-3.png").default} alt="Image 3" style={{width: "33%", padding: "5px"}} />
  <img src={require("./images/Read-intensive-workload-6.png").default} alt="Image 6" style={{width: "33%", padding: "5px"}} />
</div>
<div style={{display: "flex"}}>
  <img src={require("./images/Read-intensive-workload-2.png").default} alt="Image 2" style={{width: "33%", padding: "5px"}} />
  <img src={require("./images/Read-intensive-workload-5.png").default} alt="Image 5" style={{width: "33%", padding: "5px"}} />
  <img src={require("./images/Read-intensive-workload-7.png").default} alt="Image 7" style={{width: "33%", padding: "5px"}} />
</div>

#### Read-write balanced workload

<div style={{display: "flex"}}>
  <img src={require("./images/Read-write-balanced-workload-1.png").default} alt="Image 1" style={{width: "33%", padding: "5px"}} />
  <img src={require("./images/Read-write-balanced-workload-3.png").default} alt="Image 3" style={{width: "33%", padding: "5px"}} />
  <img src={require("./images/Read-write-balanced-workload-5.png").default} alt="Image 5" style={{width: "33%", padding: "5px"}} />
</div>
<div style={{display: "flex"}}>
  <img src={require("./images/Read-write-balanced-workload-2.png").default} alt="Image 2" style={{width: "33%", padding: "5px"}} />
  <img src={require("./images/Read-write-balanced-workload-4.png").default} alt="Image 4" style={{width: "33%", padding: "5px"}} />
  <img src={require("./images/Read-write-balanced-workload-6.png").default} alt="Image 6" style={{width: "33%", padding: "5px"}} />
</div>

#### Write-intensive workload

<div style={{display: "flex"}}>
  <img src={require("./images/Write-intensive-workload-1.png").default} alt="Image 1" style={{width: "33%", padding: "5px"}} />
  <img src={require("./images/Write-intensive-workload-3.png").default} alt="Image 3" style={{width: "33%", padding: "5px"}} />
  <img src={require("./images/Write-intensive-workload-5.png").default} alt="Image 5" style={{width: "33%", padding: "5px"}} />
</div>
<div style={{display: "flex"}}>
  <img src={require("./images/Write-intensive-workload-2.png").default} alt="Image 2" style={{width: "33%", padding: "5px"}} />
  <img src={require("./images/Write-intensive-workload-4.png").default} alt="Image 4" style={{width: "33%", padding: "5px"}} />
  <img src={require("./images/Write-intensive-workload-6.png").default} alt="Image 6" style={{width: "33%", padding: "5px"}} />
</div>

### MySQL and sysbench are deployed in two K8s clusters

<div>
  <img src={require("./images/MySQL-and-sysbench-are-deployed-in-two-K8s-clusters.png").default} alt="MySQL and sysbench are deployed in two K8s clusters" style={{padding: "10px 10%"}} />
</div>

#### Read-intensive workload

<div style={{display: "flex"}}>
  <img src={require("./images/Read-intensive-workload-two-1.png").default} alt="Image 1" style={{width: "33%", padding: "5px"}} />
  <img src={require("./images/Read-intensive-workload-two-3.png").default} alt="Image 3" style={{width: "33%", padding: "5px"}} />
  <img src={require("./images/Read-intensive-workload-two-5.png").default} alt="Image 5" style={{width: "33%", padding: "5px"}} />
</div>
<div style={{display: "flex"}}>
  <img src={require("./images/Read-intensive-workload-two-2.png").default} alt="Image 2" style={{width: "33%", padding: "5px"}} />
  <img src={require("./images/Read-intensive-workload-two-4.png").default} alt="Image 4" style={{width: "33%", padding: "5px"}} />
  <img src={require("./images/Read-intensive-workload-two-6.png").default} alt="Image 6" style={{width: "33%", padding: "5px"}} />
</div>

#### Read-write balanced workload

<div style={{display: "flex"}}>
  <img src={require("./images/Read-write-balanced-workload-two-1.png").default} alt="Image 1" style={{width: "33%", padding: "5px"}} />
  <img src={require("./images/Read-write-balanced-workload-two-3.png").default} alt="Image 3" style={{width: "33%", padding: "5px"}} />
  <img src={require("./images/Read-write-balanced-workload-two-5.png").default} alt="Image 5" style={{width: "33%", padding: "5px"}} />
</div>
<div style={{display: "flex"}}>
  <img src={require("./images/Read-write-balanced-workload-two-2.png").default} alt="Image 2" style={{width: "33%", padding: "5px"}} />
  <img src={require("./images/Read-write-balanced-workload-two-4.png").default} alt="Image 4" style={{width: "33%", padding: "5px"}} />
  <img src={require("./images/Read-write-balanced-workload-two-6.png").default} alt="Image 6" style={{width: "33%", padding: "5px"}} />
</div>

#### Write-intensive workload

<div style={{display: "flex"}}>
  <img src={require("./images/Write-intensive-workload-two-1.png").default} alt="Image 1" style={{width: "33%", padding: "5px"}} />
  <img src={require("./images/Write-intensive-workload-two-3.png").default} alt="Image 3" style={{width: "33%", padding: "5px"}} />
  <img src={require("./images/Write-intensive-workload-two-5.png").default} alt="Image 5" style={{width: "33%", padding: "5px"}} />
</div>
<div style={{display: "flex"}}>
  <img src={require("./images/Write-intensive-workload-two-2.png").default} alt="Image 2" style={{width: "33%", padding: "5px"}} />
  <img src={require("./images/Write-intensive-workload-two-4.png").default} alt="Image 4" style={{width: "33%", padding: "5px"}} />
  <img src={require("./images/Write-intensive-workload-two-6.png").default} alt="Image 6" style={{width: "33%", padding: "5px"}} />
</div>
